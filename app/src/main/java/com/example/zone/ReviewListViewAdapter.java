...
public class ReviewListViewAdapter extends BaseAdapter {
    ...
    List<ReviewModel> modellist; // main으로부터 modellist들을 전달 받을 객체
    ArrayList<ReviewModel> arrayList; // modellist로부터 받은 모델을 array형으로 받을 객체

    // ReviewListViewAdapter 생성자
    public ReviewListViewAdapter(Context context, List<ReviewModel> modellist) {
        this.mContext = context;
        this.modellist = modellist;
        inflater = LayoutInflater.from(mContext);
        this.arrayList = new ArrayList<ReviewModel>();
